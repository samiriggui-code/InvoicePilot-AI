...
/** Badge hexagone — Metronic `partials/common/hexagon-badge`. */
export function HexagonBadge({
  ...
  return (
    <div className={cn("relative shrink-0", size, className)}>
      <svg
        className={cn("h-full w-full", stroke, fill)}
        width="44"
        height="48"
        viewBox="0 0 44 48"
        fill="none"
      ...
      <div className="absolute start-2/4 top-2/4 -translate-x-2/4 -translate-y-2/4 leading-none">
        {badge}
      </div>
    </div>
  );
